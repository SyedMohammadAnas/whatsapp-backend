...
/**
 * ONE-TIME VIDEO FORWARDING SCRIPT (PRODUCTION VERSION)
 *
 * This version uses the production Cloudflare tunnel URL for the WhatsApp API.
 * Use this if you want to run the script from a different machine or remotely.
 *
 * For local execution, use forward-video-script.js instead.
 *
 * Usage:
 * node forward-video-script-production.js
 */
...
// Production WhatsApp API (Cloudflare tunnel)
const WHATSAPP_API_BASE = 'https://toronto-customize-invention-varied.trycloudflare.com';
...
async function main() {
    ...
    logger.info('VIDEO FORWARDING SCRIPT - PRODUCTION VERSION');
    logger.info('='.repeat(60));
